...
<html lang="en">
  ...
  <body>
      ...
      <a class="navbar-brand" href="index.php">Bibliothèque Fédi</a>
         ...
         <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="index.php?uc=genres&action=add">ajouter un genres</a>
            </div>
            </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="index.php?uc=auteurs&action=add">ajouter un auteurs</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="index.php?uc=nationalite&action=add">ajouter un Nationalités</a>
            </div> 
              </li>
               <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Gestion des Continent</a>
                <div class="dropdown-menu" aria-labelledby="dropdown01">
